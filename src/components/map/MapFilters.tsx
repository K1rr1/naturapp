  ...
  return (
    <>
      <button
        ...
        className="absolute top-20 right-3 z-1001 flex h-12 w-12 items-center justify-center rounded-2xl bg-stone-800 text-white shadow-xl"
      >
        {isOpen ? "✕" : "⟷"}
      </button>

      {isOpen && (
        <div className="absolute top-3 left-3 z-1000 w-76 max-w-[calc(100%-5.5rem)] rounded-3xl border border-black/5 bg-white/95 p-4 shadow-xl backdrop-blur-sm">
          <div className="mb-3">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <option value="deltar">🙋 Event jag deltar i</option>
            </select>
